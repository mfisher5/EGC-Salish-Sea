...
bash /c/Users/mfisher5/Documents/EGC-Salish-Sea/scripts/qc/run.cutadapt.undetermined.sh "${FASTQFOLDER}" "${METADATA}" "${OUTPUTFOLDER}" "${MINLENGTH}" >> /c/Users/mfisher5/Documents/EGC-Salish-Sea/data/raw/run2/undetermined/cutadapt_log_20220926.txt