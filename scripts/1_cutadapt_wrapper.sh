...
bash /c/Users/mfisher5/Documents/EGC-Salish-Sea/scripts/1.run.cutadapt.sh "${FASTQFOLDER}" "${METADATA}" "${OUTPUTFOLDER}" "${MINLENGTH}" >> /c/Users/mfisher5/Documents/EGC-Salish-Sea/data/cutadapt/log_20220909.txt