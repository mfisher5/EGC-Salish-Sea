...
```{r}
blast_filenames     <- c('hash_key_blast_2022-09-23.fasta')
filename_identifier <- c('r2')
```
<br>

Output files
```{r}
consensus_out <- 'leray_r2_blast_multipleIDs_taxonomy.csv'
unique_out    <- 'leray_r2_blast_uniqueIDs_taxonomy.csv'
all_out       <- 'leray_r2_blast_taxonomy.csv'
```
<br>
