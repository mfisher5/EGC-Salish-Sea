...
Note that the processed blast taxonomy files have results from forward-only, reverse-only, and merged reads. for this comparison, let's focus only on forward reads.
```{r message=FALSE}
